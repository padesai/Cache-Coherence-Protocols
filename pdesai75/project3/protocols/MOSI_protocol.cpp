...
{
    const char *block_states[9] = {"X","I","S","O","M","IS","IM","MS","OM"};
...
void MOSI_protocol::process_cache_request (Mreq *request)
{
    ...
    case MOSI_CACHE_IS: break;
    case MOSI_CACHE_MS: break;
    case MOSI_CACHE_OM: break;
    default:
...
void MOSI_protocol::process_snoop_request (Mreq *request)
{
    ...
    case MOSI_CACHE_MS: do_snoop_MS (request); break;
...
inline void MOSI_protocol::do_snoop_MS (Mreq *request)
{
    switch (request->msg) {
    case GETS:
	break;
